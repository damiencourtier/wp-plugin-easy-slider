...
class Easy_Slyder_Activator {
	...
	public static function activate() {
        ...
        $sql = "CREATE TABLE ".$wpdb->prefix."es_sliders ( `id_slider` INT NOT NULL AUTO_INCREMENT , `title` VARCHAR(255) NOT NULL , `slug` VARCHAR(255) NOT NULL , `params` TEXT NOT NULL , `status` BOOLEAN NOT NULL , `created_at` DATETIME NOT NULL , `updated_at` DATETIME NULL , PRIMARY KEY (`id_slider`), UNIQUE `slug` (`slug`), INDEX `status` (`status`)) $charset_collate;";
